...
public abstract class TreeSelectionModelBase<T> : ITreeSelectionModel, INotifyPropertyChanged
{
    ...
    internal class Operation(TreeSelectionModelBase<T> owner)
    {
        public int UpdateCount { get; set; }
        public bool IsSourceUpdate { get; set; }
        public IndexPath AnchorIndex { get; set; } = owner.AnchorIndex;
        public IndexPath RangeAnchorIndex { get; set; } = owner.RangeAnchorIndex;
        public IndexPath SelectedIndex { get; set; } = owner.SelectedIndex;
