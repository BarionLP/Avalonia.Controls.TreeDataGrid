...
public sealed class TextCell<T> : NotifyingBase, ITextCell, IDisposable, IEditableObject
{
    ...
    public string? Text
    {
        get
        {
            ...
            else if (_options?.StringFormat is { } format) return string.Format(_options.Culture ?? CultureInfo.CurrentCulture, format, _value);
